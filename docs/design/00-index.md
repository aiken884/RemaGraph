...
> **艦隊任務 ID**：`T-RG-D00`
> **狀態**：設計文件 2026-07-21 凍結；**v1 實作已落地**（套件 `0.1.0`，見 [`docs/reviews/v1-closeout-status.md`](../reviews/v1-closeout-status.md)）；**v2 治理/安全/可靠度/CLI 強化已實作**（套件 `0.2.0`，見 [`docs/reviews/v2-release-prep.md`](../reviews/v2-release-prep.md)）
