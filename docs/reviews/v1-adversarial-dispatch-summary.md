...
|----|------|------------|------|------|
| WU-0 | opencode-deepseek-pro (deepseek) | audit → claude-sonnet (anthropic) | family 不同 | 已派；gate 由 ruff/trigram/import 驗收 |
...
| WU-9/10 | opencode-deepseek-pro | （文件/CI 為主，以 CI gate 驗收） | — | CI/README/CHANGELOG 驗收 |
