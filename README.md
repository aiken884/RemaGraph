...
| Item | Status |
|------|--------|
| **Version** | `0.7.0-beta` (pre-1.0 beta; published on [PyPI](https://pypi.org/project/remagraph/) — `uv tool install remagraph` / `pip install remagraph`) |
...
uv tool install git+https://github.com/aiken884/RemaGraph.git@v0.7.0-beta
